<?php
	...
	if(isset($_POST['add_submit'])) {
		...
		if (empty($_POST['brand'])){
			...
			if (isset($_GET['edit'])){
				//redefine the sql query if the edit is in the URL..
...
<div class="text-center">
	<form class="form-inline" action="brands.php<?=((isset($_GET['edit']))?'?edit='.$edit_id:'');?>" method="post">
		<div class="form-group">
			<?php
				$brand_value = '';
				/*this if statement is to store the brand that's being edited in a variable
				so that we can place it in the form to make it easier for the user to edit*/
				if (isset($_GET['edit'])){
